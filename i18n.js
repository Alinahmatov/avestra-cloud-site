  ...
  const dict = {
    en: {
      ...
      hero: {
        ...
        lede: "Cameras, occupancy, and a journal — analysed on your computer and phone, stored in your internal database.",        cta: "Download / Install",
      ...
      demo: {
        ...
        cam: "Cam 0 · this PC · local store",
        note: "Fictional generated people. Not a live camera. Not stock photos of real individuals.",
        play: "Play demo",
        pause: "Pause demo",
        hunt: "hunting…",
        lock: "lock Person 1",
        named: "Person 1 · Alex",
        motion: "motion · Person 2",
        two: "occupancy 2",
        trespass: "Restriction area 1 · occupied",
        hunting: "hunting…",
        face: "face",
        j1: "Person 1 entered · dark hoodie",
        j2: "Person 1 · Alex present · named",
        j3: "laptop in view",
        j4: "Person 2 entered · olive jacket",
        j5: "crossed Restriction area 1",
        j6: "Alert emailed · still + clip",
        j7: "Person 2 left",
        alert: "ALERT",
        evidence: "Evidence saved · still + clip",
        endKicker: "Avistra Cloud",
        endTitle: "Know who walked through.",
        endLead: "Faces you enrolled, everyday objects, restriction areas and email alerts with evidence — analysed on your own PC.",
        endP1: "Face recognition",
        endP2: "Objects &amp; zones",
        endP3: "Alerts + evidence",
        endCta: "Request a license",
        endSub: "Windows · USB, CCTV, PTZ, Wi‑Fi, GoPro, phone",
      },
      features: {
        kicker: "What it sees",
        titleAccent: "A room,",
      ...
      clients: {
        ...
        w6: "Install from this site: AvistraCloud-Setup.exe",
      ...
      testers: {
        ...
        l2: "Download <strong>AvistraCloud-Setup.exe</strong>. Installing does not create an account.",
      ...
      get: {
        ...
        setupBtn: "Download / Install AvistraCloud-Setup.exe",
        ...
        need: "Request license",
        needP: "Send a request for the Developer to issue a license in Avistra Access. Name, email, and an optional note. This does not create an account and does not issue a key. After Approve, email arrives from noreply@avestra.online with Access URL and license key.",
        formKicker: "License request",
        name: "Name",
        email: "Email",
        required: "(required)",
        optional: "(optional)",
        ...
        note: "Note",
        notePh: "Anything Access should see (optional).",
      ...
      thanks: {
        ...
        dl: "Download AvistraCloud-Setup.exe",
    ...
    az: {
      ...
      hero: {
        ...
        lede: "Kameralar, doluluq və jurnal — kompüter və telefonda analiz, daxili verilənlər bazasında saxlanılır.",        cta: "Yüklə / Quraşdır",
        see: "Əməldə görün",
        cta2: "Lisenziya istə",
      ...
      demo: {
        ...
        monitoring: "MONITORING",
        occupancy: "Doluluq",
        journal: "ƏMƏL JURNALI",
        cam: "Cam 0 · bu PC · lokal yaddaş",
        note: "Uydurulmuş generated insanlar. Canlı kamera deyil. Real şəxslərin stok fotoları deyil.",
        play: "Demonu oynat",
        pause: "Demonu dayandır",
        hunt: "axtarış…",
        lock: "Person 1 kilidi",
        named: "Person 1 · Alex",
        motion: "hərəkət · Person 2",
        two: "doluluq 2",
        trespass: "Restriction area 1 · dolu",
        hunting: "axtarış…",
        face: "üz",
        j1: "Person 1 daxil oldu · tünd hudi",
        j2: "Person 1 · Alex var · adlı",
        j3: "laptop görünür",
        j4: "Person 2 daxil oldu · zeytun gödəkçə",
        j5: "Restriction area 1 keçildi",
        j6: "Xəbərdarlıq e-poçtla göndərildi · şəkil + klip",
        j7: "Person 2 çıxdı",
        alert: "XƏBƏRDARLIQ",
        evidence: "Sübut saxlandı · şəkil + klip",
        endKicker: "Avistra Cloud",
        endTitle: "Kimin keçdiyini bilin.",
        endLead: "Qeydiyyata aldığınız üzlər, gündəlik əşyalar, məhdud zonalar və sübutlu e-poçt xəbərdarlıqları — öz PC-nizdə analiz olunur.",
        endP1: "Üz tanıma",
        endP2: "Əşyalar və zonalar",
        endP3: "Xəbərdarlıq + sübut",
        endCta: "Lisenziya istə",
        endSub: "Windows · USB, CCTV, PTZ, Wi‑Fi, GoPro, telefon",
      },
      features: {
        kicker: "Nə görür",
        titleAccent: "Otaq,",
      ...
      clients: {
        ...
        w6: "Bu saytdan quraşdırma: AvistraCloud-Setup.exe",
      ...
      testers: {
        ...
        l2: "<strong>AvistraCloud-Setup.exe</strong> yükləyin. Quraşdırma hesab yaratmır.",
      ...
      get: {
        ...
        setupBtn: "Yüklə / Quraşdır AvistraCloud-Setup.exe",
        ...
        need: "Lisenziya istə",
        needP: "Developer-in Avistra Access-də lisenziya verməsi üçün sorğu göndərin. Ad, e-poçt və istəyə bağlı qeyd. Forma hesab yaratmır və açar vermir. Təsdiqdən sonra noreply@avestra.online ünvanından Access URL və lisenziya açarı gəlir.",
        formKicker: "Lisenziya sorğusu",
        name: "Ad",
        email: "E-poçt",
        required: "(məcburi)",
        ...
        note: "Qeyd",
        notePh: "Access-də görünməli istəyə bağlı qeyd.",
      ...
      thanks: {
        ...
        dl: "AvistraCloud-Setup.exe yüklə",
    ...
    ru: {
      ...
      hero: {
        ...
        lede: "Камеры, заполняемость и журнал — анализ на компьютере и телефоне, данные в вашей внутренней базе.",
      ...
      demo: {
        ...
        cam: "Cam 0 · этот ПК · локально",
        note: "Выдуманные сгенерированные люди. Не живая камера. Не стоковые фото реальных людей.",
        play: "Играть демо",
        pause: "Пауза демо",
        hunt: "поиск…",
        lock: "захват Person 1",
        named: "Person 1 · Alex",
        motion: "движение · Person 2",
        two: "заполняемость 2",
        trespass: "Restriction area 1 · занято",
        hunting: "поиск…",
        face: "лицо",
        j1: "Person 1 вошёл · тёмное худи",
        j2: "Person 1 · Alex на месте · имя",
        j3: "laptop в кадре",
        j4: "Person 2 вошёл · оливковая куртка",
        j5: "пересечение Restriction area 1",
        j6: "Оповещение отправлено · кадр + клип",
        j7: "Person 2 ушла",
        alert: "ТРЕВОГА",
        evidence: "Сохранено · кадр + клип",
        endKicker: "Avistra Cloud",
        endTitle: "Знайте, кто прошёл.",
        endLead: "Лица из вашей базы, предметы, зоны ограничения и оповещения на почту с доказательствами — анализ на вашем ПК.",
        endP1: "Распознавание лиц",
        endP2: "Предметы и зоны",
        endP3: "Оповещения + кадры",
        endCta: "Запросить лицензию",
        endSub: "Windows · USB, CCTV, PTZ, Wi‑Fi, GoPro, телефон",
      },
      features: {
        kicker: "Что видит",
        titleAccent: "Комната,",
      ...
      clients: {
        ...
        w6: "Установка с сайта: AvistraCloud-Setup.exe",
      ...
      testers: {
        ...
        l2: "Скачайте <strong>AvistraCloud-Setup.exe</strong>. Установка не создаёт аккаунт.",
      ...
      get: {
        ...
        p:
          "Avistra Cloud — десктопное приложение для <strong>Windows</strong>. Скачайте <strong>AvistraCloud-Setup.exe</strong> ниже и установите. Установка <strong>не</strong> создаёт аккаунт. Без <strong>действующей неистёкшей лицензии</strong> от Developer в Avistra Access войти всё равно нельзя (Access URL, ник, пароль и ключ). С истёкшей лицензией входа нет.",
        setupTitle: "Windows Setup.exe",
        ...
        setupBtn: "Скачать / Установить AvistraCloud-Setup.exe",
        ...
        need: "Запросить лицензию",
        needP: "Отправьте запрос, чтобы Developer выдал лицензию в Avistra Access. Имя, email и необязательная заметка. Форма не создаёт аккаунт и не выдаёт ключ. После Approve письмо с Access URL и ключом приходит с noreply@avestra.online.",
        formKicker: "Запрос лицензии",
        name: "Имя",
        email: "Email",
        ...
        note: "Заметка",
        notePh: "Что показать в Access (необязательно).",
      ...
      thanks: {
        ...
        dl: "Скачать AvistraCloud-Setup.exe",
