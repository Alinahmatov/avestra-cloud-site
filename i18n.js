(() => {
  const dict = {
    en: {
      meta: {
        title: "Avestra Cloud — See Everything. Miss Nothing.",
        description:
      ...
      hero: {
        kicker: "Avestra Cloud · Windows · local AI",
      ...
      features: {
        ...
        license:
          "You can install from this site. Sign-in still needs a <strong>valid unexpired license</strong> the Developer issued in Avestra Access — plus Access URL, nickname, and password. No self-signup. Expired keys cannot sign in.",
      },
      uses: {
        kicker: "Where Avestra is used",
        titleAccent: "Who it’s for.",
        titleRest: "Honest uses of this PC.",
        lead:
          "Avestra Cloud is a local Windows node — not a public cloud webcam. These are real jobs for occupancy, enrolled faces, the journal, and email triggers you configure.",
      ...
      how: {
        ...
        s1:
          "Get AvestraCloud-Setup.exe from this page (GitHub Releases). Run it. Installing does not create an account and does not include Avestra Access.",
      ...
      access: {
        kicker: "Avestra Access",
        titleAccent: "Four fields.",
        titleRest: "One issuer. No self-signup.",
        lead:
          "Avestra Access is a separate app on the Developer’s machine. The Windows Setup.exe is Avestra Cloud only — Access is not inside it. The Developer issues a nickname, password, and license, then sends you an Access URL. Keep Access open on the owner’s PC so Kick and activity work.",
        f1: "Field 01",
        urlTitle: "Access URL",
        url:
          "Paste the public HTTPS address from Avestra Access (<span class=\"mono\">https://….trycloudflare.com</span>). That public URL works from anywhere — same Wi‑Fi is <strong>not</strong> required. A LAN URL is same-Wi‑Fi only.",
        f2: "Field 02",
        nickTitle: "Nickname",
        ...
        plate: "Sign-in plate",
        issuer: "Issuer",
        issuerV: "The Developer, in Avestra Access",
        signup: "Self-signup",
        signupV: "None. The form queues a request in Avestra Access. After approval you get Access URL + license by email; you pick nickname and password in Cloud.",
        expiry: "Expiry",
      ...
      clients: {
        ...
        primary: "Primary",
        winTitle: "Windows — Avestra Cloud",
        ...
        a5: "Avestra Access must still be reachable to sign in",
      ...
      privacy: {
        ...
        footage:
          "Video, embeddings, the people database, the journal — on the machine that runs Avestra Cloud. There is no Avestra-hosted video pipe. Exceptions: optional household people sync, opt-in Cloudflare R2 backup you turn on yourself, and this marketing site.",
      ...
      testers: {
        ...
        l5: "Keep Avestra Access open on the owner’s PC. Kick is “Sign out everywhere.”",
        l6: "Android testers: sideload from Cloud Settings on Windows. Do not look for an APK here.",
        note: "The Setup.exe is Avestra Cloud only. Avestra Access is not inside it. License keys are never published on this page.",
      },
      faq: {
        kicker: "FAQ",
        ...
        a1: "No. Setup.exe puts Avestra Cloud on the PC. Sign-in still needs Access URL, nickname, password, and a valid unexpired license from the Developer. There is no self-signup.",
        q2: "How do I get a license?",
        a2: "Ask with the form on this page. It queues a request in Avestra Access. After the Developer approves, you get email with Access URL and license key. You pick nickname and password in Cloud. The form does not generate a key by itself. Expired licenses cannot sign in.",
        ...
        a5: "Not on this site. On Windows Avestra Cloud: Settings → Create Android app, then Start phone access and open /install on the phone.",
        ...
        a10: "There is no second huge uninstall download. On that PC: Windows Settings → Apps → Avestra Cloud → Uninstall. Or Start Menu → Avestra Cloud → Uninstall Avestra Cloud. Or run <span class=\"path\">%LOCALAPPDATA%\\Programs\\Avestra Cloud\\Uninstall.exe</span>. Program files go away. People and logs stay unless you check “Also remove local data.”",
      ...
      donate: {
        ...
        titleRest: "",
        lead:
          "This is indie software. If Avestra Cloud watches your space well, you can keep it alive with <strong>PayPal</strong> or a <strong>credit or debit card</strong>. Checkout happens on PayPal (or Stripe, if a Payment Link is configured) — this site never takes card numbers.",
        paypal: "PayPal",
      ...
      get: {
        ...
        p:
          "Avestra Cloud is a <strong>Windows</strong> desktop app. Click below to download <strong>AvestraCloud-Setup.exe</strong> and install it. Installing does <strong>not</strong> create an account. You still cannot sign in without a <strong>valid unexpired license</strong> issued by the Developer in Avestra Access (Access URL, nickname, password, and license key). Expired licenses cannot sign in.",
        setupTitle: "Windows Setup.exe",
        setupP: "Inno Setup installer. After it finishes, open Avestra Cloud and sign in with credentials the Developer issued — not a guest login, not a self-signup.",
        ...
        unTitle: "Uninstall",
        unP: "There is no separate uninstall download. After Avestra Cloud is installed, remove it on that PC:",
        un1: "Windows Settings → Apps → <strong>Avestra Cloud</strong> → Uninstall",
        un2: "Start Menu → Avestra Cloud → <strong>Uninstall Avestra Cloud</strong>",
        un3: "Or run <strong>Uninstall.exe</strong> at <span class=\"path\">%LOCALAPPDATA%\\Programs\\Avestra Cloud\\Uninstall.exe</span>",
        ...
        andP:
          "Avestra on the phone is its own monitor: the phone camera, on-device faces and COCO objects, people and a journal for that license. Sign in with the same Access URL, nickname, password, and license as Windows. It does not connect to the PC as a webcam, and the Windows Cloud app does not need to stay running. Avestra Access must be reachable to sign in. Sideload the APK from Avestra Cloud on Windows (Settings → Create Android app). The APK is not published on this site.",
        need: "Need a license?",
        needP: "Ask below if you need the Developer to issue a license in Avestra Access. The form does not create an account. A license is emailed only after Access approval.",
        ...
        reasonPh: "Who you are and why you need Avestra Cloud.",
        submit: "Request a license",
        formNote: "The request goes to Avestra Access. After approval you get email with Access URL and license key, then pick nickname and password in Cloud. Installing the exe does not create an account.",
        ...
        accessNote:
          "Licenses and sign-in nicknames are issued in <strong>Avestra Access</strong> by the Developer. This site is Avestra Cloud — the desktop surveillance app. The installer is not a login.",
        company: "Company",
      },
      footer: {
        line: "Avestra Cloud · Indie local-AI surveillance for Windows · USB · CCTV · PTZ · GoPro · phone · camera off when idle",
        meta: "www.avestra.online · local node · no self-signup",
        top: "Back to top",
      },
      thanks: {
        title: "Request sent — Avestra Cloud",
        kicker: "Request received",
        h1: "Request is in. A license is not automatic.",
        lede:
          "The request is in Avestra Access. If it is approved, email arrives with Access URL and license key. Then pick nickname and password in Cloud. Installing the Windows installer does not create an account.",
        next: "What happens next",
        nextP:
          "Watch your inbox (and spam). Use a mailbox you can actually receive mail on. Licensed copies still need Avestra Access — Access URL, nickname, password, and license key.",
        dl: "Download AvestraCloud-Setup.exe",
        back: "Back to Avestra Cloud",
      },
      notfound: {
        title: "Not found — Avestra Cloud",
        h1: "Nothing to watch here.",
        lede: "This path is empty. The Avestra Cloud site is one page.",
        back: "Avestra Cloud",
      },
    },
    az: {
      meta: {
        title: "Avestra Cloud — Hər şeyi gör. Heç nəyi qaçırma.",
        description:
      ...
      lang: { en: "English", az: "Azərbaycan", ru: "Русский" },
      hero: {
        kicker: "Avestra Cloud · Windows · lokal AI",
      ...
      features: {
        ...
        license:
          "Bu saytdan quraşdıra bilərsiniz. Giriş üçün Developer-in Avestra Access-də verdiyi <strong>etibarlı, müddəti bitməmiş lisenziya</strong> — plus Access URL, ləqəb və şifrə. Öz-özünə qeydiyyat yoxdur. Müddəti bitmiş açarla giriş olmur.",
      },
      uses: {
        kicker: "Avestra harada istifadə olunur",
        titleAccent: "Kim üçündür.",
        titleRest: "Bu PC-nin dürüst işləri.",
        lead:
          "Avestra Cloud lokal Windows qovşağıdır — ictimai bulud veb-kamerası deyil. Doluluq, qeydə alınmış üzlər, jurnal və sizin qurduğunuz e-poçt tətikləri üçün real işlər.",
        bizKicker: "Bizneslər",
      ...
      how: {
        ...
        s1:
          "AvestraCloud-Setup.exe bu səhifədən (GitHub Releases). İşə salın. Quraşdırma hesab yaratmır və Avestra Access daxil deyil.",
      ...
      access: {
        ...
        lead:
          "Avestra Access Developer-in maşınında ayrı tətbiqdir. Windows Setup.exe yalnız Avestra Cloud-dur — Access içində deyil. Developer ləqəb, şifrə və lisenziya verir, sonra Access URL göndərir. Kick və aktivlik üçün Access sahibi PC-də açıq qalsın.",
        f1: "Sahə 01",
        urlTitle: "Access URL",
        url:
          "Avestra Access-dən ictimai HTTPS ünvanı yapışdırın (<span class=\"mono\">https://….trycloudflare.com</span>). Bu ictimai URL hər yerdən işləyir — eyni Wi‑Fi <strong>şərt deyil</strong>. LAN URL yalnız eyni Wi‑Fi-dir.",
        f2: "Sahə 02",
        nickTitle: "Ləqəb",
        ...
        plate: "Giriş lövhəsi",
        issuer: "Verən",
        issuerV: "Developer, Avestra Access-də",
        signup: "Öz-özünə qeydiyyat",
        signupV: "Yoxdur. Forma Avestra Access-də növbəyə düşür. Təsdiqdən sonra Access URL + lisenziya e-poçta gəlir; ləqəb və şifrəni Cloud-da seçirsiniz.",
        expiry: "Müddət",
      ...
      clients: {
        ...
        a5: "Giriş üçün Avestra Access hələ də əlçatan olmalıdır",
      ...
      privacy: {
        ...
        footage:
          "Video, embbedinglər, insan bazası, jurnal — Avestra Cloud işləyən maşındadır. Avestra-nın host etdiyi video borusu yoxdur. İstisnalar: istəyə bağlı ev insan sinxronu, özünüz açdığınız Cloudflare R2 ehtiyatı və bu marketinq saytı.",
      ...
      testers: {
        ...
        l5: "Avestra Access sahibi PC-də açıq qalsın. Kick — “Sign out everywhere.”",
        l6: "Android testerlər: Windows-da Cloud Settings-dən sideload. Burada APK axtarmayın.",
        note: "Setup.exe yalnız Avestra Cloud-dur. Avestra Access içində deyil. Lisenziya açarları bu səhifədə heç vaxt dərc olunmur.",
      },
      faq: {
        kicker: "FAQ",
        ...
        a1: "Xeyr. Setup.exe Avestra Cloud-u PC-yə qoyur. Giriş üçün Access URL, ləqəb, şifrə və Developer-dən etibarlı, müddəti bitməmiş lisenziya lazımdır. Öz-özünə qeydiyyat yoxdur.",
        q2: "Lisenziyanı necə alım?",
        a2: "Bu səhifədəki forma Avestra Access-də növbəyə düşür. Developer təsdiq edəndən sonra Access URL və lisenziya açarı e-poçta gəlir. Ləqəb və şifrəni Cloud-da seçirsiniz. Forma özü açar yaratmır. Müddəti bitmiş lisenziya ilə giriş olmur.",
        ...
        a5: "Bu saytda yox. Windows Avestra Cloud: Settings → Create Android app, sonra Start phone access və telefondan /install açın.",
        ...
        a7: "Bu PC-nin USB kamerası, CCTV, PTZ və digər Wi‑Fi / IP kameralar RTSP və ya HTTP, GoPro USB, Wi‑Fi və ya bu PC-yə RTMP, Wi‑Fi üzərindən telefon kamerası. Adlı yuvalar əlavə edib keçid edirsiniz. Canlı analiz Avestra Cloud (və ya Access host) işləyən PC-dədir — üzlər, COCO, jurnal. İctimai SaaS veb-kamerası deyil. Android ayrıca telefondakı kameranı istifadə edir.",
        ...
        q10: "Necə silim?",
        a10: "İkinci nəhəng silmə yükləməsi yoxdur. Həmin PC-də: Windows Settings → Apps → Avestra Cloud → Uninstall. Və ya Start Menu → Avestra Cloud → Uninstall Avestra Cloud. Və ya <span class=\"path\">%LOCALAPPDATA%\\Programs\\Avestra Cloud\\Uninstall.exe</span> işə salın. Proqram faylları gedir. İnsanlar və jurnallar “Also remove local data” işarələməyincə qalır.",
      ...
      donate: {
        ...
        titleRest: "",
        lead:
          "Bu indie proqramdır. Avestra Cloud məkanınızı yaxşı izləyirsə, <strong>PayPal</strong> və ya <strong>kredit/debet kartı</strong> ilə dəstək ola bilərsiniz. Ödəniş PayPal-da (və ya Stripe Payment Link konfiqurasiya olunubsa Stripe-da) olur — bu sayt kart nömrəsi götürmür.",
        paypal: "PayPal",
      ...
      get: {
        ...
        p:
          "Avestra Cloud <strong>Windows</strong> masaüstü tətbiqidir. Aşağıdan <strong>AvestraCloud-Setup.exe</strong> yükləyib quraşdırın. Quraşdırma hesab <strong>yaratmır</strong>. Developer-in Avestra Access-də verdiyi <strong>etibarlı, müddəti bitməmiş lisenziya</strong> olmadan yenə də daxil ola bilməzsiniz (Access URL, ləqəb, şifrə və lisenziya açarı). Müddəti bitmiş lisenziya ilə giriş olmur.",
        setupTitle: "Windows Setup.exe",
        setupP: "Inno Setup quraşdırıcısı. Bitəndən sonra Avestra Cloud açın və Developer-in verdiyi məlumatlarla daxil olun — qonaq girişi və öz-özünə qeydiyyat yoxdur.",
        ...
        unTitle: "Silmək",
        unP: "Ayrı silmə yükləməsi yoxdur. Avestra Cloud quraşdırıldıqdan sonra həmin PC-də silin:",
        un1: "Windows Settings → Apps → <strong>Avestra Cloud</strong> → Uninstall",
        un2: "Start Menu → Avestra Cloud → <strong>Uninstall Avestra Cloud</strong>",
        un3: "Və ya <strong>Uninstall.exe</strong>: <span class=\"path\">%LOCALAPPDATA%\\Programs\\Avestra Cloud\\Uninstall.exe</span>",
        ...
        andP:
          "Telefondakı Avestra öz monitorudur: telefon kamerası, cihazda üzlər və COCO, həmin lisenziya üçün insanlar və jurnal. Windows ilə eyni Access URL, ləqəb, şifrə və lisenziya. PC-yə veb-kamera kimi qoşulmur, Windows Cloud açıq qalmaq məcburiyyətində deyil. Giriş üçün Avestra Access əlçatan olmalıdır. APK-nı Windows-da Avestra Cloud-dan sideload edin (Settings → Create Android app). APK bu saytda dərc olunmur.",
        need: "Lisenziya lazımdır?",
        needP: "Developer-in Avestra Access-də lisenziya verməsi üçün aşağıda yazın. Forma hesab yaratmır. Lisenziya yalnız Access təsdiqindən sonra e-poçta gəlir.",
        ...
        reasonPh: "Kimsiniz və Avestra Cloud niyə lazımdır.",
        submit: "Lisenziya istə",
        formNote: "Sorğu Avestra Access-ə düşür. Təsdiqdən sonra Access URL və lisenziya açarı e-poçta gəlir, ləqəb və şifrəni Cloud-da seçirsiniz. Exe quraşdırmaq hesab yaratmır.",
        ...
        accessNote:
          "Lisenziyalar və giriş ləqəbləri Developer tərəfindən <strong>Avestra Access</strong>-də verilir. Bu sayt Avestra Cloud-dur — masaüstü müşahidə tətbiqi. Quraşdırıcı giriş deyil.",
        company: "Şirkət",
      },
      footer: {
        line: "Avestra Cloud · Windows üçün indie lokal-AI müşahidə · USB · CCTV · PTZ · GoPro · telefon · boş olanda kamera sönülü",
        meta: "www.avestra.online · lokal qovşaq · öz-özünə qeydiyyat yox",
        top: "Yuxarı",
      },
      thanks: {
        title: "Sorğu göndərildi — Avestra Cloud",
        kicker: "Sorğu alındı",
        h1: "Sorğu gəlib. Lisenziya avtomatik deyil.",
        lede:
          "Sorğu Avestra Access-dədir. Təsdiq olunsa, Access URL və lisenziya açarı e-poçta gəlir. Sonra Cloud-da ləqəb və şifrə seçin. Windows quraşdırıcısı hesab yaratmır.",
        next: "Sonra nə olur",
        nextP:
          "Gələnlər qutusuna (və spam-ə) baxın. Həqiqətən məktub ala biləcəyiniz poçt istifadə edin. Lisenziyalı nüsxələr yenə Avestra Access tələb edir — Access URL, ləqəb, şifrə və lisenziya açarı.",
        dl: "AvestraCloud-Setup.exe yüklə",
        back: "Avestra Cloud-a qayıt",
      },
      notfound: {
        title: "Tapılmadı — Avestra Cloud",
        h1: "Burada izləyəcək bir şey yoxdur.",
        lede: "Bu yol boşdur. Avestra Cloud saytı bir səhifədir.",
        back: "Avestra Cloud",
      },
    },
    ru: {
      meta: {
        title: "Avestra Cloud — Видьте всё. Ничего не упускайте.",
        description:
      ...
      lang: { en: "English", az: "Azərbaycan", ru: "Русский" },
      hero: {
        kicker: "Avestra Cloud · Windows · локальный AI",
      ...
      features: {
        ...
        license:
          "Установить можно с этого сайта. Для входа нужна <strong>действующая неистёкшая лицензия</strong>, которую Developer выдал в Avestra Access, плюс Access URL, ник и пароль. Саморегистрации нет. Истёкшие ключи не входят.",
      },
      uses: {
        kicker: "Где используют Avestra",
        titleAccent: "Для кого.",
        titleRest: "Честные задачи этого ПК.",
        lead:
          "Avestra Cloud — локальный узел Windows, не публичная облачная веб-камера. Реальные задачи: заполняемость, внесённые лица, журнал и почтовые триггеры, которые вы сами настроили.",
        bizKicker: "Бизнес",
      ...
      how: {
        ...
        s1:
          "AvestraCloud-Setup.exe с этой страницы (GitHub Releases). Запустите. Установка не создаёт аккаунт и не включает Avestra Access.",
      ...
      access: {
        ...
        lead:
          "Avestra Access — отдельное приложение на машине Developer. Windows Setup.exe — только Avestra Cloud, Access внутри нет. Developer выдаёт ник, пароль и лицензию, затем присылает Access URL. Держите Access открытым на ПК владельца, чтобы работали Kick и активность.",
        f1: "Поле 01",
        urlTitle: "Access URL",
        url:
          "Вставьте публичный HTTPS-адрес из Avestra Access (<span class=\"mono\">https://….trycloudflare.com</span>). Публичный URL работает откуда угодно — та же Wi‑Fi <strong>не</strong> обязательна. LAN URL — только та же Wi‑Fi.",
        f2: "Поле 02",
        nickTitle: "Ник",
        ...
        issuer: "Выдаёт",
        issuerV: "Developer, в Avestra Access",
        signup: "Саморегистрация",
        signupV: "Нет. Форма ставит запрос в очередь Avestra Access. После одобрения на почту приходят Access URL и лицензия; ник и пароль вы выбираете в Cloud.",
        expiry: "Срок",
      ...
      clients: {
        ...
        a5: "Для входа Avestra Access всё равно должен быть доступен",
      ...
      privacy: {
        ...
        footage:
          "Видео, эмбеддинги, база людей, журнал — на машине с Avestra Cloud. Хостинг-трубы Avestra нет. Исключения: опциональная семейная синхронизация людей, Cloudflare R2-бэкап, который вы сами включаете, и этот маркетинговый сайт.",
      ...
      testers: {
        ...
        l5: "Держите Avestra Access открытым на ПК владельца. Kick — «Sign out everywhere».",
        l6: "Android: sideload из Cloud Settings на Windows. APK здесь не ищите.",
        note: "Setup.exe — только Avestra Cloud. Avestra Access внутри нет. Ключи лицензий на этой странице никогда не публикуются.",
      },
      faq: {
        kicker: "FAQ",
        ...
        a1: "Нет. Setup.exe ставит Avestra Cloud на ПК. Для входа нужны Access URL, ник, пароль и действующая неистёкшая лицензия от Developer. Саморегистрации нет.",
        q2: "Как получить лицензию?",
        a2: "Форма на этой странице ставит запрос в очередь Avestra Access. После одобрения Developer на почту приходят Access URL и ключ лицензии. Ник и пароль вы выбираете в Cloud. Форма сама ключ не создаёт. С истёкшей лицензией войти нельзя.",
        ...
        q5: "Где Android APK?",
        a5: "Не на этом сайте. В Windows Avestra Cloud: Settings → Create Android app, затем Start phone access и откройте /install на телефоне.",
        ...
        q10: "Как удалить?",
        a10: "Второго огромного файла удаления нет. На том ПК: Windows Settings → Apps → Avestra Cloud → Uninstall. Или Start Menu → Avestra Cloud → Uninstall Avestra Cloud. Или запустите <span class=\"path\">%LOCALAPPDATA%\\Programs\\Avestra Cloud\\Uninstall.exe</span>. Файлы программы исчезают. Люди и логи остаются, пока не отметите «Also remove local data».",
      ...
      donate: {
        ...
        titleRest: "",
        lead:
          "Это indie-ПО. Если Avestra Cloud хорошо смотрит за вашим пространством, можно поддержать через <strong>PayPal</strong> или <strong>карту</strong>. Оплата на PayPal (или Stripe, если настроен Payment Link) — этот сайт номера карт не принимает.",
        paypal: "PayPal",
      ...
      get: {
        ...
        p:
          "Avestra Cloud — десктопное приложение для <strong>Windows</strong>. Скачайте <strong>AvestraCloud-Setup.exe</strong> ниже и установите. Установка <strong>не</strong> создаёт аккаунт. Без <strong>действующей неистёкшей лицензии</strong> от Developer в Avestra Access войти всё равно нельзя (Access URL, ник, пароль и ключ). С истёкшей лицензией входа нет.",
        setupTitle: "Windows Setup.exe",
        setupP: "Установщик Inno Setup. После него откройте Avestra Cloud и войдите данными от Developer — не гостевой вход и не саморегистрация.",
        ...
        unTitle: "Удаление",
        unP: "Отдельной загрузки удаления нет. Когда Avestra Cloud установлен, удалите его на том ПК:",
        un1: "Windows Settings → Apps → <strong>Avestra Cloud</strong> → Uninstall",
        un2: "Start Menu → Avestra Cloud → <strong>Uninstall Avestra Cloud</strong>",
        un3: "Или запустите <strong>Uninstall.exe</strong>: <span class=\"path\">%LOCALAPPDATA%\\Programs\\Avestra Cloud\\Uninstall.exe</span>",
        ...
        andP:
          "Avestra на телефоне — свой монитор: камера телефона, лица и COCO на устройстве, люди и журнал этой лицензии. Вход с теми же Access URL, ником, паролем и лицензией, что на Windows. К ПК как веб-камера не подключается, Windows Cloud не обязан оставаться запущенным. Для входа Avestra Access должен быть доступен. Sideload APK из Avestra Cloud на Windows (Settings → Create Android app). APK на этом сайте не публикуется.",
        need: "Нужна лицензия?",
        needP: "Напишите ниже, если Developer должен выдать лицензию в Avestra Access. Форма не создаёт аккаунт. Лицензия приходит письмом только после одобрения в Access.",
        ...
        reasonPh: "Кто вы и зачем вам Avestra Cloud.",
        submit: "Запросить лицензию",
        formNote: "Запрос попадает в Avestra Access. После одобрения на почту приходят Access URL и ключ, ник и пароль вы выбираете в Cloud. Установка exe аккаунт не создаёт.",
        ...
        accessNote:
          "Лицензии и ники для входа выдаёт Developer в <strong>Avestra Access</strong>. Этот сайт — Avestra Cloud, десктопное наблюдение. Установщик — не логин.",
        company: "Компания",
      },
      footer: {
        line: "Avestra Cloud · Indie локальный AI-надзор для Windows · USB · CCTV · PTZ · GoPro · телефон · камера выключена без мониторинга",
        meta: "www.avestra.online · локальный узел · без саморегистрации",
        top: "Наверх",
      },
      thanks: {
        title: "Запрос отправлен — Avestra Cloud",
        kicker: "Запрос получен",
        h1: "Запрос дошёл. Лицензия не автоматическая.",
        lede:
          "Запрос в Avestra Access. Если его одобрят, письмом придут Access URL и ключ лицензии. Затем выберите ник и пароль в Cloud. Установщик Windows аккаунт не создаёт.",
        next: "Что дальше",
        nextP:
          "Проверьте входящие (и спам). Используйте ящик, на который реально приходит почта. Лицензионным копиям всё равно нужен Avestra Access — Access URL, ник, пароль и ключ.",
        dl: "Скачать AvestraCloud-Setup.exe",
        back: "Назад к Avestra Cloud",
      },
      notfound: {
        title: "Не найдено — Avestra Cloud",
        h1: "Здесь смотреть нечего.",
        lede: "Этот путь пуст. Сайт Avestra Cloud — одна страница.",
        back: "Avestra Cloud",
      },
    },
  };
