  ...
  const dict = {
    en: {
      ...
      demo: {
        ...
        lead:
          "Illustrated clip — invented faces, not a webcam, not anyone in this household. Hunt, lock <strong>Person 1 · Alex</strong>, then Person 2 walks through. Occupancy 0 → 1 → 2.",
        app: "Avistra Cloud",
        live: "Live",
    ...
    az: {
      ...
      demo: {
        ...
        lead:
          "Illüstrasiya — uydurulmuş üzlər, veb-kamera deyil, bu evdəki heç kim deyil. Axtarış, <strong>Person 1 · Alex</strong> kilidi, sonra Person 2 keçir. Doluluq 0 → 1 → 2.",
        app: "Avistra Cloud",
        live: "Live",
        monitoring: "MONITORING",
        occupancy: "Doluluq",
        ...
        j3: "laptop görünür",
        j4: "Person 2 daxil oldu · capture",
      },
      features: {
        kicker: "Nə görür",
        titleAccent: "Otaq,",
    ...
    ru: {
      ...
      demo: {
        ...
        lead:
          "Иллюстрация — выдуманные лица, не веб-камера и не кто-то из этого дома. Поиск, захват <strong>Person 1 · Alex</strong>, затем проходит Person 2. Заполняемость 0 → 1 → 2.",
        app: "Avistra Cloud",
        live: "Live",
        monitoring: "MONITORING",
